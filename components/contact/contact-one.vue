<template>
  <div class="section">
    <div class="tp-hero-2__bg black-bg-3 tp-hero-2__space-7 d-flex align-items-start justify-content-center z-index-1 p-relative fix">
        <div class="tp-hero-distort-2" style="background-image: url(/images/hero/hero-2-overlay.png);"></div>
        <div class="tp-hero-2__circle-wrapper contact-section">
          ...
          <img class="contact-shape-1 tp-zoom-in-out" src="/images/contact/contact-shape-1.png" alt="">
          <img class="contact-shape-2 tp-zoom-in-out" src="/images/contact/contact-shape-2.png" alt="">
        </div>
          ...
          <div class="row">
              <div class="col-xl-12">
                <div class="tp-contact-2__title-box text-center">
                    <h4 class="tp-contact-2__title">Take a coffee & chat with me</h4>
                </div>
